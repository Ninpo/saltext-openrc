# Salt Extension for OpenRC

Salt Extension for managing services via OpenRC
...
The saltext-openrc project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-openrc.git
...
* Writing blog posts
* Sharing your experiences using Salt + OpenRC
  on social media
...
[issues]: https://github.com/salt-extensions/saltext-openrc/issues
[PRs]: https://github.com/salt-extensions/saltext-openrc/pulls
[discussions]: https://github.com/salt-extensions/saltext-openrc/discussions
[comments]: https://conventionalcomments.org/
[docs]: https://salt-extensions.github.io/saltext-openrc/
